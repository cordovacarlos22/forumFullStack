...
userRoutes.get('/user/:userId', isAuth, isAdmin, userController.getUserById);// get user by id user most by auth
userRoutes.patch('/user/:userId', isAuth, userController.updateUserById) // update user by id 
