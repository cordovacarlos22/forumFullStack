                  ...
                  <Post />
                        ...
                        <div className="mt-4 border-2  w-3/5 ml-64 rounded-xl border-gray-400">
                            <article className="p-6 text-base bg-white rounded-lg dark:bg-gray-900">
                                ...
                                <div>
                                <button>
                                    <svg className="w-[23px] h-[23px] text-gray-800 dark:text-white hover:text-orange-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <h1 className="text-white ml-0">-50k</h1> 
                                    <button type="button">
                                    <svg className="w-6 h-6 text-gray-800 dark:text-white hover:text-orange-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
