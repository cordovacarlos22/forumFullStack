const Aside = () => {
  return (
    <>
      <aside
        id="default-sidebar"
        className="  fixed top-28 left-0 z-40 w-64 h-full transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className=" h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            <li className="dark:bg-gray-700 rounded-md ">
              <p
                href="#"
                className="font-bold text-xl flex justify-center items-center  p-2 text-gray-900 dark:text-white"
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3">Tecnología</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="ms-3">Juegos</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="ms-3">Estilo de vida</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="ms-3">Memes</span>
              </a>
            </li>
          </ul>
        </div>
